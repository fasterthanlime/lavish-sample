...
pub mod schema {
    #[derive(Debug, ::lavish::serde_derive::Deserialize, ::lavish::serde_derive::Serialize, Clone)]
    pub struct Cookie {
    ...
    pub mod reverse {
        ...
        #[derive(Clone, ::lavish::serde_derive::Deserialize, ::lavish::serde_derive::Serialize, Debug)]
        pub struct Results {
            pub s: String,
        }
    ...
    pub mod ping {
        ...
        #[derive(Debug, Clone, ::lavish::serde_derive::Serialize, ::lavish::serde_derive::Deserialize)]
        pub struct Params {
        }
